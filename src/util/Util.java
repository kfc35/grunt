...
public class Util {
	public static long[] blocks = {0, 10328, 20373, 30629, 40645, 50462, 60841, 
		...
		616148, 626448, 636240, 646022, 655804, 665666, 675448};
	
	public static final double size = 685230;
	...
	public static String blockIDString(long nodeID) {
		...
		if (nodeID >= 675448) { // After this point, the block number needs to decrease lower than our expectation
			return "67";
		} else if (nodeID < 10328) {
			return "0";
		} else {
			while (nodeID >= Util.blocks[lower + 1]) {
				lower++;
			}
		}
		return "" + lower;
